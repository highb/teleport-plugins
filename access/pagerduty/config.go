...
type PagerdutyConfig struct {
	...
	RequestAnnotations struct {
		...
		ApprovalServices string `toml:"approval_services"`
	}
}

const NotifyServiceDefaultAnnotation = "pagerduty_notify_service"
const ApprovalServiceDefaultAnnotation = "pagerduty_approval_services"
...
func (c *Config) CheckAndSetDefaults() error {
	...
	if c.Pagerduty.RequestAnnotations.ApprovalServices == "" {
		c.Pagerduty.RequestAnnotations.ApprovalServices = ApprovalServiceDefaultAnnotation
	}
	if c.Log.Output == "" {
		c.Log.Output = "stderr"
	}
